...
/**
 * Description: 定义大量本地变量，增大此方法帧中本地变量表的长度，进而影响可入栈的深度
 * java -Xss128k com.wolf.concurrenttest.underjvm.memorypartition.JavaVmStackSOF
 * 变量申请时获得128k的虚拟机栈
 * Created on 2021/7/17 9:56 AM
 *
 * @author 李超
 * @version 0.0.1
 */
